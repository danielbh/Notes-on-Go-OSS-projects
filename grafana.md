...
*Issue:* Able to remove admin user as grafana-admin leaving no users with admin permissions to Block removing super admin permission from last super admin user.
